...
def get_mean_poss_per_zone(passes, k, kmeans = False):
    ...
    pass_count_per_zone_winners = passes_winners.groupby(['zone'])['eventId'].count().values
    pass_count_per_zone_losers = passes_losers.groupby(['zone'])['eventId'].count().values
